<?php
    //$owner_email='crobertson@rivercitysecurity.com'; 
    $owner_email='jim.burns14@gmail.com';
    //$owner_email='crr.rae6@gmail.com';
    //$owner_email='connie.rae6@gmail.com';
    //SMTP server settings
    $host = 'localhost';  // 'secure158.inmotionhosting.com';
    $port = '587';  //"465";
    $username = 'info@rivercitysecurity.com';
    $password = '$ecurity4$!';
//    $host = '';
//    $port = '465';//"587";
//    $username = '';
//    $password = '';
    ...
    $subject='Vendor inquiry from Website from: ';
    $user_email='info@rivercitysecurity.com';    
    $message_body='';
    $message_type='html';
    ...
    if($owner_email==''){
            die('Attention, recipient e-mail is not set! Please define "owner_email" variable in the MailHanlder-vendor.php file.');
    }
