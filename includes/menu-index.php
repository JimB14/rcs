...
<header>
    <div class="follow-box">
        <div class="container"> 
     <!--       <p><span>"</span>In a word, this company is exceptional top to bottom.<span>"</span> - <a href="#">Martin Brown</a></p> -->
 ...
 <!--           <ul class="follow_icon">
    ...
    <div id="stuck_container">
        <div class="menuBox">  
            <div class="container"> 
                <h1 class="navbar-brand navbar-brand_"><a href="index.php"><img src="img/logo-rcs-1275x277.jpg" width="336" height="73" alt="River City Security Jacksonville FL"><span>company name</span></a></h1>
